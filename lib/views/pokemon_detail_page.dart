          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                    ...
                    SizedBox(
                      ...
                      child: Consumer(
                        builder: (context, ref, _) {
                          final favoritePokemonList = ref.watch(favoritePokemonNotifierProvider);
                          return favoritePokemonList.any((element) => element.id == pokemon.id)
                              ? GestureDetector(
                                  onTap: () {
                                    final favoritePokemonListNotifier =
                                        ref.read(favoritePokemonNotifierProvider.notifier);
                                    favoritePokemonListNotifier.removePokemonId(pokemon.id);
                                  },
                              ...
                              : GestureDetector(
                                  onTap: () {
                                    ...
                                    favoritePokemonListNotifier.addPokemon(pokemon);
                                  },
                ...
                for (int i = 0; i < pokemon.types.length; i++) Text("type${i + 1}: ${pokemon.types[i].name}"),
